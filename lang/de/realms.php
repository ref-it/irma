...
return [
    ...
    'list_explanation' => 'Hier findest du alle Studierendenschaften, denen du beitreten kannst. Nur ein/e Administrator*in (Admin) der Studierendenschaft kann grundlegende Einstellungen, wie das Setzen von Domains und Verwalten von (Rechte-)Gruppen übernehmen. Wer diese Rolle aktuell inne hat können Admins und Moderator*innen der jeweiligen Studierendenschaft einsehen. Neue Administratoren können von aktuellen Administratoren oder durch Open Administration hinzugefügt werden.',
    ...
    'dashboard.realms_edit_explanation' => 'Hier kann z.B. der Name der Studierendenschaft angepasst werden.',
    'dashboard.groups_headline' => 'Rechte',
    'dashboard.groups_explanation' => 'Hiermit ist nicht das Gegenteil von links gemeint, sondern können hier z.B Zugriffsrechte an Rollen vergeben werden. Diese Rechte können dann an andere Anwendungen, wie das StuFiS kommuniziert werden',
    'dashboard.domains_headline' => 'Domains',
    'dashboard.domains_explanation' => 'Hier können Domains hinterlegt werden, die der Studierendenschaft zuzuordnen sind. Hierüber können automatische Zuordnungen von neuen Nutzer*innen gesteuert werden.',
